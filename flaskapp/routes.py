...
from .models import User, Book, Purchase, Cart
...
@app.route('/optiflow', strict_slashes=False)
def optiflow():
    """Serves the OptiFlow template"""
    return render_template('optiflow.html')

@app.route('/aquasync', strict_slashes=False)
def aquasync():
    """Serves the aquaSync template"""
    return render_template('aquasync.html')
